...
class GUI:
    def __init__(self):
        ...
        self.original_img = self.original_img.resize((300, 300), Resampling.LANCZOS)
        self.img_tk = ImageTk.PhotoImage(self.original_img)

        original_frame = Frame(self.root, width=300, height=300)
        ...
        self.cropped_img = Image.fromarray(np.uint8(np.zeros((300, 300, 3))))
        self.cropped_img = ImageTk.PhotoImage(self.cropped_img)
        self.cropped_frame = Frame(self.root, width=300, height=300)
        ...
        self.reconstructed_img = Image.fromarray(np.uint8(np.zeros((300, 300, 3))))
        self.reconstructed_img = ImageTk.PhotoImage(self.reconstructed_img)
        self.reconstructed_frame = Frame(self.root, width=300, height=300)
    ...
    def next_image(self):
        ...
        self.original_img = img.resize((300, 300), Resampling.LANCZOS)
        self.img_tk = ImageTk.PhotoImage(self.original_img)
    ...
    def reconstruct(self):
        ...
        self.reconstructed_img = self.reconstructed_img.resize((300, 300), Resampling.LANCZOS)
        self.reconstructed_img = ImageTk.PhotoImage(self.reconstructed_img)
    ...
    def slider_up(self, event):
        ...
        self.cropped_img = self.cropped_img.resize((300, 300), Resampling.LANCZOS)
        self.cropped_img = ImageTk.PhotoImage(self.cropped_img)
